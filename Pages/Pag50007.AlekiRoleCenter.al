    ...
    actions
    {
        ...
        area(sections)
        {
            ...
            group(HumanResources)
            {
                ...
                ToolTip = 'human Resources from aplication of leave to onboarding of staff to payroll';
                group(Leave)
                {
                    group(lists)
                    {
                        action("Employee Leaves Application")
                        {
